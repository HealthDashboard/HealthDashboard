class DashboardController < ApplicationController
  ...
  def initialize
    ...
    @select_text = ["Competência (aaaamm)", "Grupo do procedimento autorizado", "Especialidade do leito", "Caráter do atendimento",
    ...
    @select_values = ["cmpt", "proce_re", "specialty_id", "treatment_type", "cid_primary", "cid_secondary", "cid_secondary2",
